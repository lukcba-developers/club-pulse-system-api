...
func CORSMiddleware(allowedOrigins []string) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.Header("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, X-Club-ID, x-request-id, X-Correlation-ID, traceparent")
